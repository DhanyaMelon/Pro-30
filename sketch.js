...
function setup() {
  ...
  //ground = new Base(50,700,12000,30);
...
function draw() {
 ...
 if (zombie.position.x >= width - 300) { zombie.velocityX = -10;
   zombie.changeAnimation("righttoleft"); } if (zombie.position.x <= 300) { zombie.velocityX = 10; 
